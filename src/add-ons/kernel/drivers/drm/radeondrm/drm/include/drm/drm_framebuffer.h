 ...
 */
inline void drm_framebuffer_get(struct drm_framebuffer *fb)
{
 ...
 */
inline void drm_framebuffer_put(struct drm_framebuffer *fb)
{
 ...
 */
inline uint32_t drm_framebuffer_read_refcount(const struct drm_framebuffer *fb)
{
 ...
 */
inline void drm_framebuffer_assign(struct drm_framebuffer **p,
					  struct drm_framebuffer *fb)
{
	if (fb)
