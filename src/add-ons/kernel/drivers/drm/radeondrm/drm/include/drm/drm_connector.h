...
inline unsigned int drm_connector_index(const struct drm_connector *connector)
{
	return connector->index;
}

inline u32 drm_connector_mask(const struct drm_connector *connector)
{
 ...
 */
inline struct drm_connector *drm_connector_lookup(struct drm_device *dev,
 ...
 */
inline void drm_connector_get(struct drm_connector *connector)
{
 ...
 */
inline void drm_connector_put(struct drm_connector *connector)
{
