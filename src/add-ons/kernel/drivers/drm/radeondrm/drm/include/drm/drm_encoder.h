 ...
 */
inline unsigned int drm_encoder_index(const struct drm_encoder *encoder)
{
 ...
 */
inline u32 drm_encoder_mask(const struct drm_encoder *encoder)
{
 ...
 */
inline bool drm_encoder_crtc_ok(struct drm_encoder *encoder,
				       struct drm_crtc *crtc)
{
 ...
 */
inline struct drm_encoder *drm_encoder_find(struct drm_device *dev,
