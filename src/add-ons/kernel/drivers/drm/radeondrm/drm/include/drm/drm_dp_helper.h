 ...
 */
inline ssize_t drm_dp_dpcd_readb(struct drm_dp_aux *aux,
 ...
 * error code on failure.
 */
inline ssize_t drm_dp_dpcd_writeb(struct drm_dp_aux *aux,
...
#else
inline void drm_dp_cec_irq(struct drm_dp_aux *aux)
{
}
...
inline void drm_dp_cec_unregister_connector(struct drm_dp_aux *aux)
{
	printf("%s::%i", __FILE__, __LINE__);
	for (int i = 0; ; i++);
}

inline void drm_dp_cec_set_edid(struct drm_dp_aux *aux,
...
inline void drm_dp_cec_unset_edid(struct drm_dp_aux *aux)
{
	printf("%s::%i", __FILE__, __LINE__);
	for (int i = 0; ; i++);
}
