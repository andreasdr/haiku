 ...
 */
inline unsigned int drm_plane_index(const struct drm_plane *plane)
{
	return plane->index;
}
 ...
 */
inline u32 drm_plane_mask(const struct drm_plane *plane)
{
 ...
 */
inline struct drm_plane *drm_plane_find(struct drm_device *dev,
